...
public class v1 extends JFrame implements ActionListener {
	...
	public v1() {
		...
		txtStock.setBounds(233, 34, 86, 20);
		txtStock.setColumns(10);
		contentPane.add(txtStock);
		
		lblNewLabel_3 = new JLabel("Stock");
		lblNewLabel_3.setBounds(188, 36, 46, 14);
		contentPane.add(lblNewLabel_3);
		
		btnNewButton = new JButton("-");
		btnNewButton.setBounds(356, 50, 55, 36);
		btnNewButton.addActionListener(this);
		contentPane.add(btnNewButton);
		
		btnNewButton_2 = new JButton("+");
		btnNewButton_2.setBounds(356, 14, 55, 36);
	...
	protected void do_btnNewButton_2_actionPerformed(ActionEvent e) {
	   try {
		   ...
		   int cantidad = +LeerStock();
		   ap.ActualizarStock(codigo, cantidad);
